...
//    public void AddTickItem(string _key)
//    {
//        GameObject find = tickItems.Find((obj) =>
//        {
//            return obj.name.Contains(_key);
//        });
//        if (find != null) return;
...
//        newObj.name = newObj.name + "(key: " + _key + ")";
...
//            if (component)
//            {
//                LocalizeStringEvent localizeStringEvent = newObj.AddComponent<LocalizeStringEvent>();

//                LocalizedString localizedString = new LocalizedString();
//                localizedString.SetReference(_tableReference, (TableEntryReference)_key);

//                localizeStringEvent.StringReference = localizedString;

//                UnityEventString unityEventString = new UnityEventString();
//                unityEventString.AddListener(_str => { component.text = _str; });
...
//    public void AddCrossItem(string _key)
//    {
//        GameObject find = tickItems.Find((obj) =>
//        {
//            return obj.name.Contains(_key);
